...
import black from "../assets/products/nike-red2.png";
import green from "../assets/products/nike-yellow2.png";
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-10">
                    ...
                    <div className="px-5 md:px-0">
                        <BuyBox 
                            ...
                            description="Tênis Nike Revolution 6 Next Nature Masculino combina conforto e sustentabilidade. Possui cabedal em mesh respirável com design moderno. A entressola macia oferece excelente amortecimento. Feito com materiais reciclados, é ideal para o dia a dia ou treinos leves. Visual esportivo, leve, versátil e com o icônico logo Nike."
                            sizes={size}
                            colors={color}
                        />
                    </div>
